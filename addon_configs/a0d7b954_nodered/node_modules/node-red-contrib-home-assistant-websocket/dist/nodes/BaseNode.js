...
class BaseNode {
    ...
    getContextValue(location, property, message) {
        ...
        return this.node
            .context()[location].get(contextKey.key, contextKey.store);
    }
    setContextValue(val, location, property, message) {
        ...
        switch (location) {
            ...
            case 'global':
                this.node
                    .context()[location].set(contextKey.key, val, contextKey.store);
                break;
            case 'msg':
            default:
    ...
    getComparatorResult(comparatorType, comparatorValue, actualValue, comparatorValueDatatype, { message, entity, prevEntity }) {
        ...
        if (['msg', 'flow', 'global'].includes(comparatorValueDatatype)) {
            cValue = this.getContextValue(comparatorValueDatatype, comparatorValue, message);
        }
    ...
    setCustomOutputs(properties = [], message, extras) {
        properties.forEach((item) => {
            ...
            try {
                this.setContextValue(value, item.propertyType, item.property, message);
            }
            catch (e) {
